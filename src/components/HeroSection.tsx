    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image 
          ...
          fill
          priority
          className="object-cover animate-scale-up dark:hidden"
        />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {/* Floating Particles */}
          <div className="absolute top-20 left-10 w-4 h-4 bg-secondary-light rounded-full animate-particle-float opacity-70" />
          <div className="absolute top-40 right-20 w-3 h-3 bg-white rounded-full animate-bounce-gentle opacity-60" />
          <div className="absolute top-60 left-1/4 w-2 h-2 bg-primary-light rounded-full animate-float opacity-90" />
          <div className="absolute bottom-40 right-10 w-5 h-5 bg-secondary rounded-full animate-bounce-slow opacity-70" />
          <div className="absolute bottom-20 left-20 w-3 h-3 bg-white rounded-full animate-particle-float opacity-80" />
          <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-primary rounded-full animate-float-delayed opacity-60" />
          <div className="absolute bottom-1/3 left-1/2 w-3 h-3 bg-secondary-light rounded-full animate-bounce-gentle opacity-50" />
          
          {/* Geometric Shapes with Enhanced Animation */}
          <div className="absolute top-32 right-1/4 w-8 h-8 border-2 border-white/40 rotate-45 animate-rotate-slow opacity-70" />
          <div className="absolute bottom-32 left-1/3 w-6 h-6 border-2 border-secondary-light/50 animate-wiggle opacity-60" />
          <div className="absolute top-1/2 left-10 w-4 h-4 border border-primary-light/40 rounded-full animate-pulse-glow opacity-50" />
          
          {/* Circuit-like connecting lines */}
          <div className="absolute top-1/4 left-1/4 w-24 h-px bg-gradient-to-r from-transparent via-white/30 to-transparent animate-shimmer" />
          <div className="absolute bottom-1/4 right-1/4 w-32 h-px bg-gradient-to-r from-transparent via-secondary-light/40 to-transparent animate-shimmer" />
          ...
          <div className="absolute bottom-16 left-16 w-12 h-12 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full animate-pulse-glow opacity-40" />
        </div>
      </div>
      
      {/* Hero Content */}
      <div className="relative mt-32 z-10 max-w-7xl mx-auto px-6 text-center text-white">
        {/* Animated Badge */}
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6  leading-tight">
          ...
          <span className="block bg-gradient-to-r from-secondary-light via-white to-primary-light bg-clip-text text-transparent animate-fade-in-delay-1">
            Legal Intelligence
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-in-delay-3">
          <Button 
            asChild
            size="lg" 
            className="bg-secondary hover:bg-secondary-dark text-white px-8 py-4 text-lg font-semibold shadow-glow transition-all duration-300 hover:scale-105 hover:shadow-xl group "
          >
            <Link href="/dashboard">
              Enter AI Platform
          ...
          <Button 
            size="lg" 
            variant="outline"
            className="bg-white/20 dark:bg-white/10 border-white/50 dark:border-white/30 text-white hover:bg-white/30 dark:hover:bg-white/20 px-8 py-4 text-lg font-semibold backdrop-blur-sm transition-all duration-300 hover:scale-105 group shadow-lg"
          >
